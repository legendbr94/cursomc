...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("999958955", "959489842"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 203", "Jardim", "74481110", cli1, c1);
		Endereco e2 = new Endereco(null, "Av Matos", "105", "Sala 800", "Centro", "74481110", cli1, c2);
